...
const StartupAdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://hamlin-backend.onrender.com/api/startup", {
      headers: {
  ...
  const updateStatus = (id: string, status: string) => {
    ...
    fetch(`https://hamlin-backend.onrender.com/api/startup/${id}`, {
      method: "PATCH",
      headers: {
              ...
              startups.map((s) => (
                ...
                >
                  ...
                  <td className="p-3 space-y-1 text-blue-600 text-xs">
                    {s.registrationFile && (
                      <a
                        href={`https://hamlin-backend.onrender.com/uploads/${s.registrationFile}`}
                        target="_blank"
                    ...
                    {s.pitchDeck && (
                      <a
                        href={`https://hamlin-backend.onrender.com/uploads/${s.pitchDeck}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block hover:underline"
                      >
                    ...
                    {s.businessPlan && (
                      <a
                        href={`https://hamlin-backend.onrender.com/uploads/${s.businessPlan}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block hover:underline"
                      >
                    ...
                    {s.financialModel && (
                      <a
                        href={`https://hamlin-backend.onrender.com/uploads/${s.financialModel}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block hover:underline"
                      >
                    ...
                    {s.founderProfile && (
                      <a
                        href={`https://hamlin-backend.onrender.com/uploads/${s.founderProfile}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block hover:underline"
                      >
